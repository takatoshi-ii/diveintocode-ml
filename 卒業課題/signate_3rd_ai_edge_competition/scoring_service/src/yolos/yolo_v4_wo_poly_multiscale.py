...
if __name__ == "__main__":
    ...
    def _main():
        ...
        if phase == 1:
            ...
            model = create_model(input_shape, anchors, num_classes, load_pretrained=True, weights_path='training/ep034-loss4.009-val_loss4.301.h5')
        ...
        model.compile(optimizer=Adadelta(0.2), loss={'yolo_loss': lambda y_true, y_pred: y_pred})
        epochs = 100
