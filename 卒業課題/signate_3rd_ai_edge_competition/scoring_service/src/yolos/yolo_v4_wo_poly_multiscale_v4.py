...
if __name__ == "__main__":
    ...
    def _main():
        ...
        annotation_path = 'data_for_yolo_training.txt'
        validation_path = 'data_for_yolo_val.txt'
        log_dir = 'training/'
        classes_path = 'yolo_classes.txt'
        anchors_path = 'yolo_anchors.txt'
        ...
        if phase == 1:
            ...
            model = create_model(input_shape, anchors, num_classes, load_pretrained=True, weights_path='training/ep001-loss2.081-val_loss2.194.h5')
        ...
        clr = CyclicLR(base_lr=0.01, max_lr=1.0, step_size=20000,  mode='triangular2')
