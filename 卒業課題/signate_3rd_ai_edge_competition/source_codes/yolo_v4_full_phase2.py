...
if __name__ == "__main__":
    ...
    def _main():
        ...
        if phase == 1:
            ...
            model = create_model(input_shape, anchors, num_classes, load_pretrained=True, weights_path=r'D:\SIGNATE\Signate_3rd_AI_edge_competition\training\model4\phase1\log/model4_phase1.h5')
        ...
        clr = CyclicLR(base_lr=0.01, max_lr=1.0, step_size=5000, mode='triangular2')
