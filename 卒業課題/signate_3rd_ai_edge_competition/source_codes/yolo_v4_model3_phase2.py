...
if __name__ == "__main__":
    ...
    def _main():
        ...
        if phase == 1:
            ...
            model = create_model(input_shape, anchors, num_classes, load_pretrained=True, weights_path=r'D:\SIGNATE\Signate_3rd_AI_edge_competition\training\model3\phase1\log/model3_phase1.h5')
